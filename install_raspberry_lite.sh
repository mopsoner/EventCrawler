...
sudo apt update
sudo apt install -y python3 python3-pip python3-venv python3-dev git curl libxml2-dev libxslt1-dev
...
printf '\n[5/7] Installing lite Python dependencies...\n'
python -m pip install -r requirements_lite.txt

printf '\n[6/7] Preparing directories...\n'
mkdir -p data exports
chmod +x lite_crawler.py app.py run_lite.sh || true
...
This 32-bit lite mode does not use Playwright.
